...
public class Player
{
     ...
     * 玩家退出回合，退出房间
     */
    public void exitBout()
    {
        // 移除玩家
        game.addAction(new PlayerExitAction(getUserID(), 0));
        game.sendToAll(null, UserCmdOutType.EXIT_BOUT_RETURN_VALUE, this);
        gamePlayer.onExitBout();
    }
}
