 ...
 * @author dream.wang
 */
public abstract class AbstractPlayerModule<E extends AbstractGamePlayer>
{
    protected E player;

    public AbstractPlayerModule(E player)
    {
        this.player = player;
    }

    public E getGamePlayer()
    {
        return player;
    }
