...
public class OrmEntityCodeUtil
{
     ...
     * @return
     */
    public static String generateEntityCode(String name, String tableName,
            Map<String, FieldInfo> fieldMap, Map<String, Boolean> methods)
    {
        ...
        /* 所属包 */
        result.append(
                "package " + CommonUtil.generateORMEntityPackage(tableName))
                .append(";\n\n");
        ...
        {
            result.append(CommonUtil.default_orm_annotationImport)
                    .append("\n");
        }
...
//        result.append("import java.io.Serializable;").append("\n");
        ...
        if (methods.get("CreateBeanAnnotation") != null
                && methods.get("CreateBeanAnnotation") == true)
        {
            result.append("@ICreateBeanAnnotation(desc = \"").append(tableName)
                    .append("\")").append("\n");
        }
        ...
        //Dream 添加序列化信息
        result.append("public class " + tmp +" extend ChangedObject " + "\n");
...
//      }
     ...
     * @return
     */
    private static Object generateOrmConfig(String tableName,
            Map<String, FieldInfo> fieldMap)
    {
        StringBuffer sb = new StringBuffer();
        sb.append("@PersistentEntity(sourceDomain = ")
                .append("\"" + tableName + "\"").append(", targetDomain = ");
        sb.append("\"" + tableName + "\"");
     ...
     * @return
     */
    private static StringBuffer generateMethodClonePublic(String entityName,
            String tableName, Map<String, FieldInfo> fieldMap)
    {
        ...
        result.append("\t{\n");
        result.append("\t\t").append(className).append(" clone = new ")
        ...
        while (it.hasNext())
        {
            ...
            result.append("\t\tclone.").append("set").append(CommonUtil.toUpperName(fieldName)).append("(this.get").append(CommonUtil.toUpperName(fieldName)).append("());\n");
        }
