 ...
 *
 */
@WebHandleAnnotation(cmdName = "/delVersion", description = "版本")
public class RemoveVersionServlet extends PlayerHandlerServlet
{
    ...
    public String execute(String jsonString, HttpServletRequest request, HttpServletResponse response)
    {
        ...
        if (requestInfo != null)
        {
            boolean result = ServerComponent.deleteVersion(requestInfo.getVersionID());
            if (result)
                return "ok";
