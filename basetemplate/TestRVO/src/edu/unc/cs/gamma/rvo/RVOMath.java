...
class RVOMath
{
     ...
     *
     * @param vector1
     *            The top row of the two-dimensional square matrix.
     * @param vector2
     *            The bottom row of the two-dimensional square matrix.
     ...
     * @param point3
     *            The point to which the signed distance is to be calculated.
