...
public class Simulator
{
     ...
     *            The maximum distance (center point to center
     ...
     *            non-negative.
     * @param maxNeighbors
     *            The maximum number of other agents this agent
     *            takes into account in the navigation. The
     *            larger this number, the longer the running
     *            time of the simulation. If the number is too
     *            low, the simulation will not be safe.
     * @param timeHorizonAgents
     ...
     *            positive.
     * @param radius
     *            The radius of this agent. Must be
     *            non-negative.
     * @param maxSpeed
     *            The maximum speed of this agent. Must be
     *            non-negative.
     * @param velocity
     *            The initial two-dimensional linear velocity
     *            of this agent.
     * @return The number of the agent.
     */
    public int addAgent(Vector2D position, double neighborDistance, int maxNeighbors, double timeHorizonAgents, double timeHorizonObstacles, double radius, double maxSpeed,
            Vector2D velocity)
    {
        final Agent agent = new Agent();
        agent.id = agents.size();
     ...
     *
     * @param vertices
     *            ArrayList of the vertices of the polygonal obstacle in
    ...
    public int addObstacle(List<Vector2D> vertices)
    {
        ...
        for (int vertexNo = 0; vertexNo < vertices.size(); vertexNo++)
        {
            ...
            obstacle.convex = vertices.size() == 2 || RVOMath.leftOf(vertices.get(vertexNo == 0 ? vertices.size() - 1 : vertexNo - 1), vertices.get(vertexNo),
                    vertices.get(vertexNo == vertices.size() - 1 ? 0 : vertexNo + 1)) >= 0.0;
     ...
     *
     * @param agentNo
     *            The number of the agent whose agent neighbor is to be
     *            retrieved.
     * @param neighborNo
     *            The number of the agent neighbor to be retrieved.
     ...
     *
     * @param agentNo
     *            The number of the agent whose maximum neighbor count is to
     *            be retrieved.
     ...
     *
     * @param agentNo
     *            The number of the agent whose maximum speed is to be
     *            retrieved.
     ...
     *
     * @param agentNo
     *            The number of the agent whose maximum neighbor distance is
     *            to be retrieved.
     ...
     *
     * @param agentNo
     *            The number of the agent whose count of agent neighbors is
     *            to be retrieved.
     ...
     *
     * @param agentNo
     *            The number of the agent whose count of obstacle neighbors
     *            is to be retrieved.
     ...
     *
     * @param agentNo
     *            The number of the agent whose obstacle neighbor is to
     *            be retrieved.
     * @param neighborNo
     *            The number of the obstacle neighbor to be retrieved.
     ...
     *
     * @param agentNo
     *            The number of the agent whose ORCA constraints are to be
     *            retrieved.
     ...
     *
     * @param agentNo
     *            The number of the agent whose two-dimensional position is
     *            to be retrieved.
     ...
     *
     * @param agentNo
     *            The number of the agent whose time horizon is to be
     *            retrieved.
     ...
     *
     * @param agentNo
     *            The number of the agent whose time horizon with respect to
     ...
     *
     * @param agentNo
     *            The number of the agent whose two-dimensional linear
     *            velocity is to be retrieved.
     ...
     *
     * @param vertexNo
     *            The number of the obstacle vertex whose successor is to
     *            be retrieved.
     ...
     *
     * @param vertexNo
     *            The number of the obstacle vertex whose predecessor is to
     *            be retrieved.
     ...
     * @param radius
     *            The minimal distance between the line connecting the two
     ...
     *
     * @param neighborDistance
     *            The default maximum distance (center point to
     ...
     *            non-negative.
     * @param maxNeighbors
     *            The default maximum number of other agents a
     ...
     *            not be safe.
     * @param timeHorizonAgents
     *            The default minimal amount of time for which
     ...
     *            non-negative.
     * @param maxSpeed
     *            The default maximum speed of a new agent.
     *            Must be non-negative.
     * @param velocity
     *            The default initial two-dimensional linear
     *            velocity of a new agent.
     */
    public void setAgentDefaults(double neighborDistance, int maxNeighbors, double timeHorizonAgents, double timeHorizonObstacles, double radius, double maxSpeed,
            Vector2D velocity)
    {
        if (defaultAgent == null)
        {
     ...
     *
     * @param agentNo
     *            The number of the agent whose maximum neighbor count
     *            is to be modified.
     * @param maxNeighbors
     ...
     *            modified.
     * @param maxSpeed
     *            The replacement maximum speed. Must be non-negative.
     */
     ...
     * @param neighborDistance
     *            The replacement maximum neighbor distance. Must
     *            be non-negative.
     */
     ...
     *            The replacement of the two-dimensional preferred
     *            velocity.
     */
     ...
     *
     * @param agentNo
     *            The number of the agent whose radius is to be modified.
     * @param radius
     ...
     *
     * @param agentNo
     *            The number of the agent whose time horizon is to
     *            be modified.
     * @param timeHorizonAgents
     ...
     *
     * @param agentNo
     *            The number of the agent whose time horizon
     ...
     * @param velocity
     *            The replacement two-dimensional linear velocity.
     */
