...
public class UserDataDaoImpl extends BaseDao<UserData> implements IUserDataDao
{
	...
	public boolean add(UserData userData)
	{
		...
		String sql = "insert into t_p_user(`UserID`, `OpenID`, `UserName`, `Password`, `RegisterDate`, `LastLoginDate`, `Gold`, `Level`, `Money`) values(?, ?, ?, ?, ?, ?, ?, ?, ?);";
		...
		params.put(Types.VARCHAR,userData.getPassword());
		params.put(Types.TIMESTAMP,userData.getRegisterDate());
		params.put(Types.TIMESTAMP,userData.getLastLoginDate());
		params.put(Types.INTEGER,userData.getGold());
		params.put(Types.INTEGER,userData.getLevel());
		params.put(Types.INTEGER,userData.getMoney());
	...
	{
		boolean result = false;
		String sql = "update t_p_user set `OpenID`=?, `UserName`=?, `Password`=?, `RegisterDate`=?, `LastLoginDate`=?, `Gold`=?, `Level`=?, `Money`=? where `UserID`=?;";
		DBParamWrapper params = new DBParamWrapper();
		params.put(Types.VARCHAR,userData.getOpenID());
		params.put(Types.VARCHAR,userData.getUserName());
		params.put(Types.VARCHAR,userData.getPassword());
	...
	{
		boolean result = false;
		String sql = "insert into t_p_user(`UserID`, `OpenID`, `UserName`, `Password`, `RegisterDate`, `LastLoginDate`, `Gold`, `Level`, `Money`) values(?, ?, ?, ?, ?, ?, ?, ?, ?) on DUPLICATE KEY update `OpenID`=?,`UserName`=?,`Password`=?,`RegisterDate`=?,`LastLoginDate`=?,`Gold`=?,`Level`=?,`Money`=?;";
		DBParamWrapper params = new DBParamWrapper();
		params.put(Types.BIGINT,userData.getUserID());
		params.put(Types.VARCHAR,userData.getOpenID());
		params.put(Types.VARCHAR,userData.getUserName());
	...
	public UserData rsToEntity(ResultSet rs) throws SQLException
	{
		...
		userData.setMoney(rs.getInt("Money"));
		return userData;
	}
