...
public class ClassSizeUtil
{
  ...
  public ClassSizeUtil(byte nullReferenceSize, byte emptyObjectSize, byte emptyArrayVarSize) {
    ...
    public static ClassSizeUtil forJRockitVM()
    {
        return new ClassSizeUtil((byte) 4, (byte) 8, (byte) 8);
    }

    public static ClassSizeUtil forSun32BitsVM()
    {
        return new ClassSizeUtil((byte) 4, (byte) 8, (byte) 4);
    }

    public static ClassSizeUtil forSun64BitsVM()
    {
        return new ClassSizeUtil((byte) 8, (byte) 16, (byte) 8);
    }

    public static ClassSizeUtil forDetectedVM()
    {
        return null;
    }
    ...
    public static void main(String[] args)
    {
        ...
        int size=util.sizeof(new Byte("1"));
    ...
    private static int occupyofConstructor(Object object, Field field)
    {
        throw new UnsupportedOperationException(
                "field type Constructor not accessible: " + object.getClass() + " field:" + field);
    }
    ...
    private static int sizeofPrimitiveClass(Class clazz)
    {
        return clazz == boolean.class || clazz == byte.class ? 1
                : clazz == char.class || clazz == short.class ? 2 : clazz == int.class || clazz == float.class ? 4
                        : 8;
    }
